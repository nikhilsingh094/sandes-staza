                            ...
                            <div class="modal-dialog">
                                <div class="modal-content" style={{ padding: "2%" }}>
                                    <div class="modal-header">
                                        ...
                                        <Typography variant="h6" mb={2}>Group Registration Form</Typography>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <form>
                                        <div className="row">
                                        <Typography variant="p"  mt={2} textAlign="center">Ministry:</Typography>
                                        <Typography variant="h6" mb={1}textAlign="center">Ministry for POC</Typography>
                                            ...
                                            <Typography variant="p"  mt={1} textAlign="center">Organization Name:</Typography>
                                            <Typography variant="h6" mb={1}  textAlign="center">Organization for POC</Typography>
